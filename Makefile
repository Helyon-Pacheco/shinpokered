...
$(pokered_obj): 			RGBASMFLAGS += -D _RED -D _ENCRED -D _SWBACKS -D _FPLAYER -D _MOVENPCS -D _RUNSHOES -D _EXPBAR -D _METRIC -D _SWSPRITES -D _JPTXT
$(pokeblue_obj): 			RGBASMFLAGS += -D _BLUE -D _ENCBLUEGREEN -D _SWBACKS -D _FPLAYER -D _MOVENPCS -D _RUNSHOES -D _EXPBAR -D _METRIC -D _SWSPRITES -D _JPTXT
